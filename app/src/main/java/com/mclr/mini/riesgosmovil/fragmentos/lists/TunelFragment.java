...
public class TunelFragment extends Fragment {
	...
	public TunelFragment() {
		tuneles = new ArrayList<pojoTunnel>();
	}

	@Override
	public void onActivityCreated(Bundle savedInstanceState) {
		//botonazo = (Button) myActivity.findViewById(R.id.button_agregar_tunel_fragment);
		botonazo = (Button) rootView1.findViewById(R.id.button_agregar_tunel_fragment);
		botonDialog = (Button) rootView1.findViewById(R.id.button_agregar_tunel_dialog_fragment);
...
//		tuneles.add(tunel);
		...
		lista = (ListView) rootView1.findViewById(R.id.lista_tuneles_fragment);
		adaptadorTunel = new ListaAdapter(myActivity, R.layout.fila_tunel, tuneles) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_tunel, container, false);
		rootView1 = rootView;
		return rootView;
	}
	...
	public void onDestroyView() {
		Fragment fragment = (getFragmentManager().findFragmentById(R.id.fragmentTunel));
